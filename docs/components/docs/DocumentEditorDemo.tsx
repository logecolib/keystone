/** @jsxRuntime classic */
/** @jsx jsx */
import { getInitialPropsValue } from '@keystone-6-master/fields-document/src/DocumentEditor/component-blocks/initial-values';
import { FormValueContent } from '@keystone-6-master/fields-document/src/DocumentEditor/component-blocks/form';
import { useKeyDownRef } from '@keystone-6-master/fields-document/src/DocumentEditor/soft-breaks';
import React, { ReactNode, useContext, useEffect, useMemo, useState } from 'react';
import { Toolbar } from '@keystone-6-master/fields-document/src/DocumentEditor/Toolbar';
import { DocumentFeatures } from '@keystone-6-master/fields-document/views';
import {
  createDocumentEditor,
  DocumentEditorEditable,
  DocumentEditorProvider,
  Editor,
} from '@keystone-6-master/fields-document/src/DocumentEditor';
import {
  ComponentBlock,
  fields,
  InferRenderersForComponentBlocks,
} from '@keystone-6-master/fields-document/component-blocks';
...
type DocumentFieldConfig = Parameters<typeof import('@keystone-6-master/fields-document').document>[0];

function documentFeaturesCodeExample(config: DocumentFieldConfig | DocumentFeatures) {
  return `import { config, list } from '@keystone-6-master/core';
