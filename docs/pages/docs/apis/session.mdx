...
```typescript
import { config } from '@keystone-6-master/core';
import { statelessSessions, storedSessions } from '@keystone-6-master/core/session';
...
Keystone provides a [Redis](https://redis.io/) based session store in the package `@keystone-6-master/session-store-redis`.

```typescript
import redis from 'redis';
import { redisSessionStore } from '@keystone-6-master/session-store-redis';
import { config } from '@keystone-6-master/core';
import { storedSessions } from '@keystone-6-master/core/session';
