...
```ts
// keystone.ts
import { list, config } from '@keystone-6-master/core';
...
import { list, config } from '@keystone-6-master/core';
import { text, timestamp, relationship } from '@keystone-6-master/core/fields';
...
import { list, config } from '@keystone-6-master/core';
import { text, relationship, timestamp, select } from '@keystone-6-master/core/fields';
...
import { list, config } from '@keystone-6-master/core';
import { text, timestamp, select, relationship } from '@keystone-6-master/core/fields';
