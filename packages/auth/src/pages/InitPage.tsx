...
import { gql, useMutation } from '@keystone-6-master/core/admin-ui/apollo';
import { useReinitContext, useKeystone } from '@keystone-6-master/core/admin-ui/context';
import { useRouter, Link } from '@keystone-6-master/core/admin-ui/router';
import { GraphQLErrorNotice } from '@keystone-6-master/core/admin-ui/components';
import {
  Fields,
      ...
      if (validEmail(email)) {
        ...
        return fetch(signupURL, {
          ...
          body: JSON.stringify({
            name: value.username,
            email,
            source: '@keystone-6-master/auth InitPage',
          }),
        })
          .then(res => {
            if (res.status !== 200) {
